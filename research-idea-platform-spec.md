...
ResearchGit V2 is scoped to CHI 2026 authors. Users sign in with Google, match an author record from `papers_by_room.json`, browse their authored papers, generate grounded ideas, join broader topic canvases, add sticky notes, comment on public work, and save AI-enhanced draft versions.
...
- `plans/abstract-pondering-starfish.md` lists current module pointers.
